package com.android.launcherx.model;
...
import com.android.launcherx.InvariantDeviceProfile;
import com.android.launcherx.ItemInfo;
import com.android.launcherx.LauncherAppState;
import com.android.launcherx.LauncherAppWidgetProviderInfo;
import com.android.launcherx.LauncherModel;
import com.android.launcherx.LauncherProvider;
...
import com.android.launcherx.backup.nano.BackupProtos;
    ...
    public static void markForMigration(
        ...
        Utilities.getPrefs(context).edit()
                .putString(KEY_MIGRATION_SRC_WORKSPACE_SIZE,
                        getPointString((int) srcProfile.getDesktopCols(), (int) srcProfile.getDesktopRows()))
                .putString(KEY_MIGRATION_SRC_HOTSEAT_SIZE,
                        getPointString((int) srcProfile.getHotseatCount(), srcProfile.getAllappsRank()))
